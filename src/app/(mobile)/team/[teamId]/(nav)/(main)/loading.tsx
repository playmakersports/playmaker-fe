  ...
  return (
    <>
      ...
      <div style={{ display: "flex", marginTop: "22px", padding: "24px 20px" }}>
        <div className="skeleton-loading-ui" style={{ width: "74px", height: "74px", borderRadius: "50%" }} />
        <div style={{ display: "flex", flexDirection: "column", gap: "10px", margin: "4px 0px 0px 20px" }}>
          <div className="skeleton-loading-ui" style={{ width: "170px", height: "20px", borderRadius: "5px" }} />
          <div className="skeleton-loading-ui" style={{ width: "170px", height: "20px", borderRadius: "5px" }} />
        </div>
      </div>
    </>
