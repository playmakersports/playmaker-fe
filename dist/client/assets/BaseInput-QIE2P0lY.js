...
`,v=s.input`
  ...
  &:not(:placeholder-shown):focus + div.dropdown-icons > ${C} {
    width: 20px;
    opacity: 1;
    & + div.divider {
      width: 1px;
  ...
  &:disabled {
    & + div.dropdown-icons > ${C} {
      display: none;
    }
  }
`,F=s(v).attrs({as:"button"})`
  display: flex;
